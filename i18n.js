...
const strings = {
  he: {
    dir: "rtl",
    lang: "he",
    brand: "מרידיאן נגרייה",
    brandShort: "מרידיאן",
    metaTitle: "מרידיאן נגרייה — מטבחים וארונות בהתאמה אישית",
    ...
    step3Title: "ייצור מדויק בסדנה",
    step3Copy: "דיוק CNC לצד חיבורי יד. כל פאנל, קצה ורווח נבדקים מול התכניות.",
    ...
    workshop: "סדנה",
    workshopAddr: "רחוב הנגרים 184, רובע הנהר",
    hours: "שעות פעילות",
    ...
    formOk: "תודה — בקשת הייעוץ התקבלה. ניצור קשר בהקדם.",
    footerNote: "תיק עבודות בלבד · ללא מחירים · נגרות בהתאמה מאז 2009",
    footerCopy: "מרידיאן נגרייה",
    categories: {
  ...
  ar: {
    dir: "rtl",
    lang: "ar",
    brand: "ميريديان للنجارة",
    brandShort: "ميريديان",
    metaTitle: "ميريديان للنجارة — مطابخ وخزائن حسب الطلب",
    ...
    step3Title: "تصنيع دقيق في الورشة",
    step3Copy: "دقة CNC مع وصلات يدوية. كل لوح وحافة وفراغ يُطابق المخططات.",
    ...
    workshop: "الورشة",
    workshopAddr: "١٨٤ ساحة الخشب، حي النهر",
    hours: "ساعات العمل",
